        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800">Jenis Penugasan</h3>
                        <p class="text-xs text-gray-400">Pilihan 'Jenis Tugas'</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <li class="px-4 py-3 flex items-center justify-between group hover:bg-gray-50 transition">
                        ...
                        <div class="flex items-center gap-2 opacity-50 group-hover:opacity-100 transition">
                            <button onclick="openModal('edit', 'Jenis Tugas', '{{ $type['name'] }}', {{ $type['id'] }})" class="text-blue-600 hover:bg-blue-50 p-1.5 rounded-md">
                                <span class="sr-only">Edit {{ $type['name'] }}</span>
                            ...
                            <button onclick="deleteItem('{{ $type['name'] }}')" class="text-red-600 hover:bg-red-50 p-1.5 rounded-md">
                                <span class="sr-only">Padam {{ $type['name'] }}</span>
                ...
                <div class="bg-gray-50 px-4 py-2 border-t border-gray-100 relative z-10">
                    <p class="text-[10px] text-gray-400 text-center">{{ count($types) }} rekod</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
             <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800">Kawasan Penugasan</h3>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gray-50 px-4 py-2 border-t border-gray-100 relative z-10">
                    <p class="text-[10px] text-gray-400 text-center">{{ count($areas) }} rekod</p>
                </div>
            </div>
        </div>
        ...
        <div class="relative z-10 w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden ring-1 ring-black/5 transform transition-all">
            ...
            <div class="p-6">
                <form id="modalForm" action="#" method="POST">
                    ...
                    <label for="itemName" class="block text-sm font-medium text-gray-700 mb-1">Nama Item</label>
